        ...
        self.page_html = """<!DOCTYPE html>
                                ...
                                function initialize() {
                                        ...
                                        var info2 = new google.maps.InfoWindow({
                                                content: "<h3>Marker2</h3> <p>Unleaded: {0}</p> <p>Diesel: {1}</p> <p>Other: {2}</p>"
                                        });
                                        ...
                                        var info3 = new google.maps.InfoWindow({
                                                content: "<h3>Marker3</h3> <p>Unleaded: {0}</p> <p>Diesel: {1}</p> <p>Other: {2}</p>"
                                        });
                                        ...
                                        var info4 = new google.maps.InfoWindow({
                                                content: "<h3>Marker4</h3> <p>Unleaded: {0}</p> <p>Diesel: {1}</p> <p>Other: {2}</p>"
                                        });
                                        ...
                                        var info5 = new google.maps.InfoWindow({
                                                content: "<h3>Marker5</h3> <p>Unleaded: {0}</p> <p>Diesel: {1}</p> <p>Other: {2}</p>"
                                        });
                                        ...
                                        var info6 = new google.maps.InfoWindow({
                                                content: "<h3>Marker6</h3> <p>Unleaded: {0}</p> <p>Diesel: {1}</p> <p>Other: {2}</p>"
                                        });
                                        ...
                                        var info7 = new google.maps.InfoWindow({
                                                content: "<h3>Marker7</h3> <p>Unleaded: {0}</p> <p>Diesel: {1}</p> <p>Other: {2}</p>"
                                        });
                                        ...
                                        var info8 = new google.maps.InfoWindow({
                                                content: "<h3>Marker8</h3> <p>Unleaded: {0}</p> <p>Diesel: {1}</p> <p>Other: {2}</p>"
                                        });
                                        ...
                                        var info9 = new google.maps.InfoWindow({
                                                content: "<h3>Marker9</h3> <p>Unleaded: {0}</p> <p>Diesel: {1}</p> <p>Other: {2}</p>"
                                        });
